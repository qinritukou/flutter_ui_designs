            ...
            Expanded(
              child: Padding(
                ...
                child: ListView(
                  scrollDirection: Axis.horizontal,
                  children: <Widget>[
                    FadeAnimation(1.4, makeItem(image: 'assets/images/one.png')),
                    FadeAnimation(1.5, makeItem(image: 'assets/images/two.png')),
                    FadeAnimation(1.6, makeItem(image: 'assets/images/three.png')),
                  ],
                ),
              ),
            ),
