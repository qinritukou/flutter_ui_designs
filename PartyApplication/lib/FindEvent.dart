        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 30,),
              FadeAnimation(1.2, makeItem(image: 'assets/images/one.png', date: 17),),
              SizedBox(height: 20,),
              FadeAnimation(1.2, makeItem(image: 'assets/images/two.png', date: 18),),
              SizedBox(height: 20,),
              FadeAnimation(1.2, makeItem(image: 'assets/images/three.png', date: 19),),
              SizedBox(height: 20,),
              FadeAnimation(1.2, makeItem(image: 'assets/images/four.png', date: 20),),
